...
void gx_gui_create_window_and_surface(gx_hyperionUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_hyperionUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_hyperionUI *ui) {
	...
	UnregisterClass(TEXT("gx_hyperionUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_hyperionUI *ui = (gx_hyperionUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
